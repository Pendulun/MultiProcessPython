...
# Toda vez que usarmos o saldo de uma conta, usamos o lock/unlock
...
def valida_banco(contas, total):
    ...
    if atual != total:
        print(f'ERRO: Balanço bancario inconsistente: BRL$ {atual:.2f} vs {total:.2f}', flush=True)
    else:
